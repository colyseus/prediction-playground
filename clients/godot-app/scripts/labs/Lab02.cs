...
namespace Playground
{
    ...
    /// </summary>
    public partial class Lab02 : LabBase<Lab.BotsState>
    {
        ...
        public override void Render(App app)
        {
            ...
            float x0 = app.Stage.Position.X + 24, x1 = app.Stage.End.X - 20, y = app.Stage.End.Y - 34;
            if (x1 - x0 > 200)
            {
                ...
                foreach (double t in _arrivals)
                {
                    ...
                    Draw.Rect(new Rect2(px - 2, y - 2, 4, 4), Palette.Good);
                }
                Draw.Text(x0, y - 18, 420, "patch arrivals (local clock, last 3 s) ->",
                    Palette.A(Palette.Text, 0.55f), 10);
            }
