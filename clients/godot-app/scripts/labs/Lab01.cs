...
namespace Playground
{
    ...
    /// </summary>
    public partial class Lab01 : LabBase<Lab.MoveState>
    {
        ...
        {
            if (Kb.Key(Key.R)) _damped = !_damped;
            if (Kb.Key(Key.Minus) && _damping > 4) _damping -= 2;
            if (Kb.Key(Key.Equal) && _damping < 30) _damping += 2;
