...
| 10 composite-sim | SimReconciler (`predict.sim`) | ✅ native + Unity (ported, §5); ⬜ Defold/Haxe |
...
Lab 10 is done in C and C#; still blocked on the SimReconciler port in Lua and Haxe (§5).
