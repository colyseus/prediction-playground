...
// Drop gate: K kills the socket uncleanly (close 4010) and the SDK's polled
...
console.log(reconnected
  ? 'DROP RECONNECT OK (second connect after K)'
  : 'DROP RECONNECT FAIL (no reconnect seen after K)');
await browser.close();
